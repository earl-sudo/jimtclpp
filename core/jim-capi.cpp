...
JIM_CAPI_INLINE void Jim_IncrRefCount(Jim_ObjPtr  objPtr) { 
    JIM_NAMESPACE_NAME::Jim_IncrRefCount((JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr); 
}
JIM_CAPI_INLINE void Jim_DecrRefCount(Jim_InterpPtr  interp, Jim_ObjPtr  objPtr) { 
    JIM_NAMESPACE_NAME::Jim_DecrRefCount((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr); 
}
JIM_CEXPORT int  Jim_RefCount(Jim_ObjPtr  objPtr) { 
    return JIM_NAMESPACE_NAME::Jim_RefCount((JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr); 
}
JIM_CAPI_INLINE int Jim_IsShared(Jim_ObjPtr  objPtr) { 
    return JIM_NAMESPACE_NAME::Jim_IsShared((JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr); 
}
...
JIM_CEXPORT int Jim_MakeTempFile(Jim_InterpPtr interp,
    ...
    return JIM_NAMESPACE_NAME::Jim_MakeTempFile((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, filename_template, unlink_file); 
}
//
/* evaluation */
JIM_CEXPORT Retval Jim_Eval(Jim_InterpPtr interp, const char* script) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_Eval((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, script); 
}
...
JIM_CEXPORT Retval Jim_EvalSource(Jim_InterpPtr interp, const char* filename,
    ...
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalSource((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, filename, lineno, script); 
}
/* Backwards compatibility */


JIM_CEXPORT Retval Jim_EvalGlobal(Jim_InterpPtr interp, const char* script) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalGlobal((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, script); 
}
JIM_CEXPORT Retval Jim_EvalFile(Jim_InterpPtr interp, const char* filename) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalFile((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, filename); 
}
JIM_CEXPORT Retval Jim_EvalFileGlobal(Jim_InterpPtr interp, const char* filename) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalFileGlobal((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, filename); 
}
JIM_CEXPORT Retval Jim_EvalObj(Jim_InterpPtr interp, Jim_ObjPtr  scriptObjPtr) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalObj((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)scriptObjPtr); 
}
JIM_CEXPORT Retval Jim_EvalObjVector(Jim_InterpPtr interp, int objc,
                                     Jim_ObjConstArray objv) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalObjVector((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, objc, (JIM_NAMESPACE_NAME::Jim_ObjConstArray)objv); 
}
JIM_CEXPORT Retval Jim_EvalObjList(Jim_InterpPtr interp, Jim_ObjPtr  listObj) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalObjList((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)listObj); 
}
JIM_CEXPORT Retval Jim_EvalObjPrefix(Jim_InterpPtr interp, Jim_ObjPtr  prefix,
                                     int objc, Jim_ObjConstArray objv) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalObjPrefix((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)prefix, objc, (JIM_NAMESPACE_NAME::Jim_ObjConstArray)objv); 
}
...
JIM_CEXPORT Retval Jim_EvalNamespace(Jim_InterpPtr interp, Jim_ObjPtr  scriptObj, Jim_ObjPtr  nsObj) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_EvalNamespace((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)scriptObj, (JIM_NAMESPACE_NAME::Jim_ObjPtr)nsObj); 
}
JIM_CEXPORT Retval Jim_SubstObj(Jim_InterpPtr interp, Jim_ObjPtr  substObjPtr,
                                Jim_ObjArray* resObjPtrPtr, int flags) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_SubstObj((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)substObjPtr, (JIM_NAMESPACE_NAME::Jim_ObjArray*)resObjPtrPtr, flags); 
}
...
JIM_CEXPORT void Jim_FreeStackElements(Jim_StackPtr stack, void(*freeFunc)(void* ptr)) { 
    JIM_NAMESPACE_NAME::Jim_FreeStackElements((JIM_NAMESPACE_NAME::Jim_StackPtr)stack, freeFunc);
}

/* hash table */
JIM_CEXPORT void Jim_InitHashTable(Jim_HashTablePtr ht,
                                   const Jim_HashTableType* type, void* privdata) { 
    JIM_NAMESPACE_NAME::Jim_InitHashTable((JIM_NAMESPACE_NAME::Jim_HashTablePtr)ht, (const JIM_NAMESPACE_NAME::Jim_HashTableType*)type, privdata); 
}
JIM_CEXPORT void Jim_ExpandHashTable(Jim_HashTablePtr ht,
                                     unsigned_int size) { 
    return JIM_NAMESPACE_NAME::Jim_ExpandHashTable((JIM_NAMESPACE_NAME::Jim_HashTablePtr)ht, size); 
}
JIM_CEXPORT Retval Jim_AddHashEntry(Jim_HashTablePtr ht, const void* key,
                                    void* val) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_AddHashEntry((JIM_NAMESPACE_NAME::Jim_HashTablePtr)ht, key, val); 
}
JIM_CEXPORT int Jim_ReplaceHashEntry(Jim_HashTablePtr ht,
                                     const void* key, void* val) { 
    return JIM_NAMESPACE_NAME::Jim_ReplaceHashEntry((JIM_NAMESPACE_NAME::Jim_HashTablePtr)ht, key, val); 
}
JIM_CEXPORT Retval Jim_DeleteHashEntry(Jim_HashTablePtr ht,
                                       const void* key) { 
    return (Retval) JIM_NAMESPACE_NAME::Jim_DeleteHashEntry((JIM_NAMESPACE_NAME::Jim_HashTablePtr)ht, key); 
}
JIM_CEXPORT void Jim_FreeHashTable(Jim_HashTablePtr ht) { 
    JIM_NAMESPACE_NAME::Jim_FreeHashTable((JIM_NAMESPACE_NAME::Jim_HashTablePtr)ht); 
}
JIM_CEXPORT Jim_HashEntryPtr  Jim_FindHashEntry(Jim_HashTablePtr ht,
                                                const void* key) { 
    return (Jim_HashEntryPtr) JIM_NAMESPACE_NAME::Jim_FindHashEntry((JIM_NAMESPACE_NAME::Jim_HashTablePtr)ht, key); 
}
...
JIM_CEXPORT Jim_ObjPtr  Jim_DuplicateObj(Jim_InterpPtr interp,
                                         Jim_ObjPtr  objPtr) { 
    return (Jim_ObjPtr) JIM_NAMESPACE_NAME::Jim_DuplicateObj((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr); 
}
JIM_CEXPORT const char* Jim_GetString(Jim_ObjPtr  objPtr,
                                      int* lenPtr) { 
    return JIM_NAMESPACE_NAME::Jim_GetString((JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr, lenPtr); 
}
...
JIM_CEXPORT Jim_ObjPtr  Jim_NewStringObj(Jim_InterpPtr interp,
    ...
    return (Jim_ObjPtr) JIM_NAMESPACE_NAME::Jim_NewStringObj((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, s, len); 
}
JIM_CEXPORT Jim_ObjPtr  Jim_NewStringObjUtf8(Jim_InterpPtr interp,
                                             const char* s, int charlen /* num chars */) { 
    return (Jim_ObjPtr) JIM_NAMESPACE_NAME::Jim_NewStringObjUtf8((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, s, charlen); 
}
JIM_CEXPORT Jim_ObjPtr  Jim_NewStringObjNoAlloc(Jim_InterpPtr interp,
                                                char* s, int len /* -1 means strlen(s) */) { 
    return (Jim_ObjPtr) JIM_NAMESPACE_NAME::Jim_NewStringObjNoAlloc((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, s, len); 
}
JIM_CEXPORT void Jim_AppendString(Jim_InterpPtr interp, Jim_ObjPtr  objPtr,
                                  const char* str, int len /* -1 means strlen(s) */) { 
    JIM_NAMESPACE_NAME::Jim_AppendString((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr, str, len); 
}
JIM_CEXPORT void Jim_AppendObj(Jim_InterpPtr interp, Jim_ObjPtr  objPtr,
                               Jim_ObjPtr  appendObjPtr) { 
    JIM_NAMESPACE_NAME::Jim_AppendObj((JIM_NAMESPACE_NAME::Jim_InterpPtr)interp, (JIM_NAMESPACE_NAME::Jim_ObjPtr)objPtr, (JIM_NAMESPACE_NAME::Jim_ObjPtr)appendObjPtr); 
}
