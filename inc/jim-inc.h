...
JIM_API_INLINE Jim_Obj* Jim_GetResult(Jim_InterpPtr  i) { return (i)->result(); }
JIM_API_INLINE void* Jim_CmdPrivData(Jim_InterpPtr  i) { return ((i)->cmdPrivData_); }

JIM_API_INLINE Jim_Obj* Jim_NewEmptyStringObj(Jim_InterpPtr  i) { return Jim_NewStringObj(i, "", 0); }
